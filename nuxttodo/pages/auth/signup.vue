  ...
  <AuthLayout>
      ...
      <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          >
            ...
            <UButton type="submit" block label="Sign up" :loading="isLoading" />
          </UForm>
    ...
    <UModal v-model="isOpen">
      ...
      >
        ...
        <div class="h-32">
          <h1 class="text-xl">
            We has send an email confirmation in your email?
          </h1>
        </div>
      </UCard>
    </UModal>
...
const form = ref<Form<SignupSchema>>();
...
async function onSubmit(event: FormSubmitEvent<SignupSchema>) {
  ...
  try {
    ...
    let res = await useUseSanctumFetch("/register", "POST", credential);
